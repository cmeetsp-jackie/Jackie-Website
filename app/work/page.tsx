...
const projects = [
  {
    ...
    details: {
      ...
      pressReleases: [
        {
          title: '차란, 품질보증 C2C 패션 거래 서비스 \'차란마켓\' 출시',
          source: '패션비즈',
          date: '2026.01',
        ...
        {
          title: '패션 리커머스 차란, 시리즈B에서 168억원 투자 유치',
          source: '플래텀',
          date: '2025.09',
        ...
        {
          title: '중고 패션, 지난해 2분에 1개씩 팔렸다…잘 나가는 \'차란\' 비법은?',
          source: '유니콘팩토리',
          date: '2025.03',
        ...
        {
          title: '[성공사례] 출시 1년 9개월만에 233배 성장한 차란의 토스페이 활용법',
          source: 'Toss Blog',
          date: '2025',
        ...
        {
          title: '[쫌아는기자들] 차란, 세컨핸드 시장에서 \'제2의 쿠팡\' 후보로 떠오르다',
          source: '조선일보',
          date: '2025.01',
        ...
        {
          title: '차란, 중고의류 판매로 연간 9천톤 탄소 감축…"소나무 99만 그루 효과"',
          source: '플래텀',
          date: '2024.03',
